...
public class ActionFactory implements ServletContextListener{
	...
	private static ServletContext context;
		...
		/**
		 * <p> クライアントのリクエストパスを受け取り </p>
		 * <p> リクエストパスとActionクラスの対応付けはweb.xmlファイルにて
		 * context-paramタグを使用して設定 </p>
		 * <p> ServletContxtオブジェクトのgetInitParameterメソッドを使用して取得する </p>
		 * 
		 * @param servletPath (request path)
		 * @return Action
		 * @throws ServletException
		 */
		private static Action getAction(String servletPath) throws ServletException
		{
			Action action = null;
